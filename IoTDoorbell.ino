...
Serial.print(".");
delay(500);
bot.sendMessage(idChat, "IoT Doorbel, escribe /ayuda para ver las opciones", "");//Enviamos un mensaje a telegram para informar que el sistema está listo
}
Serial.println();
...
clientTCP.println("Content-Type: multipart/form-data; boundary=IotDoorbell");
clientTCP.println();
...
if (text == "/fotoConflash") {//Toma una foto con flash
envioFoto = true;
...
ayuda += "/fotoConflash: saca una foto con flash y luego lo desactiva \n";
